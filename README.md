...
```
cd existing_repo
git remote add origin https://gitlab.com/francesco.mazzi/gifty.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/francesco.mazzi/gifty/-/settings/integrations)
